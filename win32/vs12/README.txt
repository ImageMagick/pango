...
$(srcroot)\vs12 in the case of GLib (stable/unstable).
...
<root>\<this-pango-source-tree>\win32\vs12\README.txt.
...
needs to be found in <root>\vs12\<PlatformName>\.  Note also that this is not
...
"installed" to <root>\vs12\<PlatformName>\share\gir-1.0 (the .gir file(s)) and
<root>\vs12\<PlatformName>\lib\girepository-1.0 (the .typelib files(s)) upon
